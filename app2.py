...
# ----------------- Login Page -----------------
    ...
    with st.expander("Reset Password"):
        rp_username = st.text_input("Registered Username", key="rp_user")
        rp_cnic = st.text_input("Registered CNIC (without dashes)", key="rp_cnic")
        new_pass = st.text_input("New Password", type="password", key="rp_new")
        new_pass2 = st.text_input("Confirm New Password", type="password", key="rp_new2")
